...
# 步骤
1. 读当前 `{governance_root}/workspace-<NNN>-<slug>/workspace.md`、其 `goal-tree.md`、`00-meta.md`、`01-decision.md` 索引、`01-decision/D-*` 与 legacy inline。若 workspace Root Goal/canonical 范围与目标不匹配，停止受影响决策，先记录或请求修复上下文；没有显式工作区根时只处理 legacy 隐式单工作区。
