...
├── GOAL-004-core-data-model · 实现核心数据模型与 Goal 基础管理 [active 50%]
...
| GOAL-004-core-data-model | 实现核心数据模型与 Goal 基础管理 | GOAL-001-main-vision | active | 50% | [GOAL-004-core-data-model/](GOAL-004-core-data-model/) |
