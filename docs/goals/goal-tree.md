...
├── GOAL-003-skills-practice · 完善 Skills 并在本项目中实践验证 [active 70%]
...
| GOAL-003-skills-practice | 完善 Skills 并在本项目中实践验证 | GOAL-001-main-vision | active | 70% | [GOAL-003-skills-practice/](GOAL-003-skills-practice/) |
...
2. 新目标从现有最大编号 +1 顺序分配（当前下一个：`GOAL-005`）。
