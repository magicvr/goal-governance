...
```text
python scripts/compatibility_report.py --require-ready --output docs/workspaces/workspace-002-methodology-skills-feedback/GOAL-004-frozen-web-asset-retirement/attachments/s4-compatibility-report-2026-08-04.json
exit: 0
...
```text
python scripts/release_evidence.py --mode rehearsal --run-checks --compatibility-report docs/workspaces/workspace-002-methodology-skills-feedback/GOAL-004-frozen-web-asset-retirement/attachments/s4-compatibility-report-2026-08-04.json --output docs/workspaces/workspace-002-methodology-skills-feedback/GOAL-004-frozen-web-asset-retirement/attachments/s4-release-evidence-2026-08-04.json
exit: 0
