...
6. 新 runtime evidence 固化到根级发行证据路径 `docs/releases/runtime/v0.12.0/`；不改写 `docs/workspaces/workspace-001-goal-governance/GOAL-008-skills-consumer-adapter-release-consistency/` 的历史捕获物或 lifecycle 状态。
