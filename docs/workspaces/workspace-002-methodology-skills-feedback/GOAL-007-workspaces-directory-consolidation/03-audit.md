...
S4 cross 已完成：A-001 self `pass`；A-002 Grok Build independent `conditional`，F-001 经 A-003 `fixed`，R-001/R-002 同步修正；开放 required finding = 0。S5 仍须以 PR/CI/main/tag/Release 远端事实完成。
