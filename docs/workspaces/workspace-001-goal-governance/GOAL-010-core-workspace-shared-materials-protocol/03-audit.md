...
- 当前工作区的 `workspace.md` 已将 `GOAL-001-main-vision` 绑定到 `docs/workspaces/workspace-001-goal-governance/`；[workspace-protocol.md](../../../architecture/workspace-protocol.md) 第 1～2、4 节明确该根是当前 canonical scope，`docs/goals/` 只适用于没有显式工作区根的外部 legacy 仓库。
