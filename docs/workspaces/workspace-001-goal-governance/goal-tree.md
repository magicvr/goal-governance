...
- **现时 canonical 目标状态根**：本目录 `docs/workspaces/workspace-001-goal-governance/`（含本 `goal-tree.md` 与平铺 `GOAL-*`）。
...
GOAL-011 完成当前仓库到 `docs/workspaces/workspace-001-goal-governance/` 的迁移与共享资料候选索引骨架。该过程数据为 dogfood，不随 Web/Skills 发布复制给其他项目。
